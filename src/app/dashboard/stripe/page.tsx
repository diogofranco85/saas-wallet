    ...
    const handleCreateAccount = async (e: React.FormEvent) => {
        ...
        try {
            const payload = {
                ...
                business_type: createAccountForm.business_type,
                ...(createAccountForm.business_type === "company"
                    ? {
                        company: {
                            name: createAccountForm.company_name,
                            tax_id: createAccountForm.company_tax_id,
                            phone: createAccountForm.company_phone,
                        },
                    }
                    : {
                        individual: {
                            first_name: createAccountForm.individual_first_name,
                            last_name: createAccountForm.individual_last_name,
                            email: createAccountForm.individual_email,
        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="text-center">
                    ...
                    <p>Carregando configurações do Stripe...</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Configurações do Stripe</h1>
                    <p className="text-muted-foreground">Gerencie sua conta Stripe para receber pagamentos PIX</p>
                </div>
                {canCreateAccount && !stripeData.stripe_account_id && (
                    <Dialog open={createAccountDialog} onOpenChange={setCreateAccountDialog}>
                        ...
                        <DialogContent className="max-w-2xl">
                            <DialogHeader>
                                <DialogTitle>Criar Conta Stripe</DialogTitle>
                                <DialogDescription>Configure sua conta Stripe para começar a receber pagamentos PIX</DialogDescription>
                            </DialogHeader>
                    ...
                    {stripeData.stripe_account_id ? (
                        ...
                        <div className="text-center py-8">
                            ...
                            <p className="text-muted-foreground mb-4">
                                Nenhuma conta Stripe configurada. Configure uma conta para começar a receber pagamentos PIX.
                            </p>
                            {canCreateAccount ? (
                                <Button onClick={() => setCreateAccountDialog(true)}>Criar Conta Stripe</Button>
                            ) : (
                                <p className="text-sm text-muted-foreground">
                                    Apenas o proprietário da empresa pode configurar a conta Stripe.
                                </p>
                            )}
                        </div>
                    )}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Como funcionam os pagamentos PIX com Stripe</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-4 border rounded-lg">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    O Stripe cobra uma taxa por transação PIX. Consulte a documentação oficial para valores atualizados.
                                </p>
                            </div>
                            <div className="p-4 border rounded-lg">
                            ...
                            <div className="p-4 border rounded-lg">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Pagamentos PIX têm limites baseados no tipo de conta e verificação. Consulte seu dashboard Stripe.
                                </p>
                            </div>
                            <div className="p-4 border rounded-lg">
                                <h4 className="font-medium mb-2">Suporte</h4>
                                <p className="text-sm text-muted-foreground">
                                    Para questões sobre pagamentos, acesse o dashboard Stripe ou entre em contato com o suporte.
                                </p>
                            </div>
                        </div>
                    </div>
