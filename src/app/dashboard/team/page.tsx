...
import { Mail, UserPlus, Copy, Trash2, RefreshCw, Users, Activity } from "lucide-react"
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-foreground">Gerenciar Equipe</h1>
                    <p className="text-muted-foreground">Convide e gerencie membros da sua equipe</p>
                </div>
